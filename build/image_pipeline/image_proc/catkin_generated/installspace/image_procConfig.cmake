...
if("FALSE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/temethextreme/convlog_ws/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/temethextreme/convlog_ws/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/temethextreme/convlog_ws/install)
...
if(NOT "include;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/temethextreme/convlog_ws/install/${idir}'.  ${_report}")
    endif()
